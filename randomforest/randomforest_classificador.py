...
# Crear el model Random Forest amb el paràmetre class_weight='balanced'
best_params = {
    'bootstrap': True,
    'class_weight': 'balanced',  # Aquí estem utilitzant class_weight per equilibrar les classes
    'max_depth': 10,
    'max_features': 'sqrt',
    'min_samples_leaf': 2,
